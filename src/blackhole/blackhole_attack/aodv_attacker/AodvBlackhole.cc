...
Define_Module(AodvBlackhole);

AodvBlackhole::AodvBlackhole() {
...
void AodvBlackhole::handleRREQ(const Ptr<Rreq>& rreq, const L3Address& sourceAddr, unsigned int timeToLive)
{
...
const Ptr<Rrep> AodvBlackhole::createFakeRREP(const Ptr<Rreq>& rreq, IRoute *destRoute, IRoute *originatorRoute, const L3Address& lastHopAddr)
{
...
AodvBlackhole::Result AodvBlackhole::ensureRouteForDatagram(Packet *datagram) {
