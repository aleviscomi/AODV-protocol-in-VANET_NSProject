...
#ifndef __INET_ARPPOISONING_H
#define __INET_ARPPOISONING_H
 ...
 * ARP implementation.
 */
class INET_API ArpPoisoning : public OperationalBase, public IArp
{
  public:
    class ArpCacheEntry;
    ...
    {
      public:
        ArpPoisoning *owner = nullptr;    // owner ARP module of this cache entry
  ...
  protected:
    cMessage *arpPoisoningTimerMsg = nullptr;
    double arpPoisoningTimer = 0;
    double arpPoisoningStart = 0;
    const char *victim1str;
    const char *victim2str;
  ...
  protected:
    void sendFakeArpReply(Ipv4Address victim1, Ipv4Address victim2, MacAddress macVictim1, MacAddress myMACAddress);
    void handleArpPoisoningTimerMsg();
